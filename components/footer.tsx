      ...
      <footer className="site-footer">
        <div className="container">
          <div className="footer-grid">
            ...
            <div><div className="footer-title">Get help</div><div className="footer-links"><Link href="/prescription">Prescription inquiry</Link><Link href="/corporate">Corporate procurement</Link><Link href="/contact">Contact</Link><a href={feedbackFormUrl} target="_blank" rel="noreferrer" data-conversion="feedback_form_click" data-intent="client_feedback" data-location="footer">Share feedback</a></div></div>
