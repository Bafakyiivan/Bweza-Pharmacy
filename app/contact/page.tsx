  ...
  return <>
    ...
    <section className="section"><div className="container">
      <div className="contact-cards" id="confirm-details">
        ...
        <a className="contact-card" href={phoneHref()} aria-label="Call Bweza Pharmacy"><span>Phone — tap to call</span><strong>{site.phone}</strong></a>
    ...
    <section className="section section-soft"><div className="container form-shell">
      <div><p className="eyebrow">General enquiry</p><h2 className="heading" style={{ fontSize: "clamp(2rem,3.5vw,3rem)" }}>How can we <span>help?</span></h2><p className="lead">Send a short, clear message. Do not include sensitive health information here; use the prescription route where appropriate.</p><div className="button-row"><a className="button button-magenta" href={wa} target={isExternalWhatsApp ? "_blank" : undefined} rel={isExternalWhatsApp ? "noreferrer" : undefined}>Open WhatsApp</a><a className="button button-secondary" href={phoneHref()}>Call pharmacy</a></div></div>
