...
export default function PrivacyPage() {
  return <>
    ...
    <section className="section"><div className="container privacy-content">
      ...
      <h2>Prescription information</h2><p className="lead">Prescription requests can be started through Bweza Pharmacy’s WhatsApp account or submitted through the secure website form. Files submitted through the website are stored in a private Supabase storage area and are not attached to staff-notification emails. Send only the prescription and information needed for the request; do not send identity documents, payment information or unrelated medical records. WhatsApp processes messages sent through its service under its own terms and privacy practices.</p>
      <h2>Hosting, analytics and service providers</h2><p className="lead">Vercel hosts the website, Supabase provides private prescription storage, Google provides the general, corporate and customer-feedback forms, and WhatsApp provides the prescription-message route. If enabled, Google Analytics and Meta may process limited website interaction information, such as pages visited and button clicks. These services may process information outside Uganda.</p>
